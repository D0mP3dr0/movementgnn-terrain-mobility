"""
06b_extract_topo_embeddings.py — GNN_TOPO embedding extraction (Pacaraima)
===========================================================================
Self-contained script for Google Colab. Extracts terrain embeddings from
a pre-trained HierarchicalTerrainGNN checkpoint using spatial chunking.
...
_emb = get_embedding_extraction_paths(local=False)
CKPT_PATH  = _emb["ckpt"]
